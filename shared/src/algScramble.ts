...
// isIdentical), not hand-derived — kept in sync with the identical copy in
...
// Combines adjacent same-face moves into their net turn (see
// CubeDiagram.tsx's fuller doc comment on this same function). A second
// pass then collapses every maximal run of pure rotation tokens to its
// shortest equivalent — same-letter cancellation alone can't catch a run
// like "x2 y z y' x" (a genuine no-op) since no two adjacent tokens there
// share a face letter.
